...
filestoreplace.forEach(function (val, index, array) {
    if (fs.existsSync(val)) {
        ...
        var packageName = configobj.installed_plugins["cordova-plugin-continuous-take-pictures"]["PACKAGE_NAME"];
        console.log("With the package name: " + packageName);
        console.log("Adding import for R.java");
        replace_string_in_file(val, "io.cordova.myappb6ea24", packageName);
